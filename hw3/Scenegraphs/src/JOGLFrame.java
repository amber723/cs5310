...
public class JOGLFrame extends JFrame {
    ...
    public JOGLFrame(String title, String filename) {
        //routine JFrame setting stuff
        super(title);
        setSize(800, 500); //this opens a 400x400 window
        ...
        canvas.addGLEventListener(new GLEventListener() {
            ...
            public void init(GLAutoDrawable glAutoDrawable) {
                //called the first time this canvas is created. Do your initialization here
                try {
                    ...
                    JOptionPane.showMessageDialog(JOGLFrame.this, e.getMessage(),
            ...
            public void display(GLAutoDrawable glAutoDrawable) { //called every time this window must be redrawn
                ...
                textRenderer.drawText(glAutoDrawable, text, 10,
                        canvas.getSurfaceHeight() - 50, 1, 0, 0, 20.0f);
    ...
    private class KeyboardListener implements KeyListener {
        ...
        public void keyPressed(KeyEvent e) {
            switch (e.getKeyCode()) {
                case KeyEvent.VK_UP:
                    JOGLFrame.this.view.move_camera(10);//move forward
                    JOGLFrame.this.canvas.repaint();
                    break;
                case KeyEvent.VK_DOWN:
                    JOGLFrame.this.view.move_camera(-10);//move behind
                    JOGLFrame.this.canvas.repaint();
                    break;

                case KeyEvent.VK_LEFT:
                    JOGLFrame.this.view.node_no(-1);
                    JOGLFrame.this.canvas.repaint();
                    break;
                ...
                case KeyEvent.VK_1:
                    JOGLFrame.this.view.node_yes(-1);
                    JOGLFrame.this.canvas.repaint();
                    break;
                case KeyEvent.VK_2:
                    JOGLFrame.this.view.node_yes(1);
                ...
                case KeyEvent.VK_Y:
                    JOGLFrame.this.dispose();
                    JFrame frame = new JOGLFrame("Scene graph Viewer",
                            "scenegraphmodels/humanoid-YMCA.xml");
                    frame.setVisible(true);
                    break;
                case KeyEvent.VK_R:
                    JOGLFrame.this.dispose();
                    frame = new JOGLFrame("Scene graph Viewer",
                            "scenegraphmodels/rooms.xml");
                    frame.setVisible(true);
                    break;
            }
        }
